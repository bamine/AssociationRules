...
namespace AssociationRules
{
    public class ItemSet : IEquatable<ItemSet>
    {
        ...
        public bool Equals(ItemSet other)
        {
            ...
            return other.Count == Count && Support == other.Support && other.Items.OrderBy(a => a).SequenceEqual(Items.OrderBy(a => a));
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return (Count * 397) ^ (Items != null ? Items.GetHashCode() : 0);
            }
        }

        public override string ToString()
        {
            return string.Format("ItemSet[Size: {0}, Items: {1}]", Count, String.Join(" - ", Items));
        }
